...
$stmt = $pdo->prepare("
SELECT t.TeamID, t.TeamName, u.Nom AS NomU ,u.Prenom AS PrenomU FROM Teams t JOIN TeamMembers tm ON t.TeamID = tm.TeamID 
JOIN
                    ...
                    <div class="relative mx-4 mt-4 overflow-hidden text-gray-700 bg-white h-80 rounded-xl bg-clip-border">
                     ...
                     <div class="p-6">
                         <div class="flex items-center justify-between mb-2">
                           ...
                           <p class="block font-sans text-base antialiased font-medium leading-relaxed text-blue-gray-900">My Full Name: <?= $project['NomU'] ?> <?= $project['PrenomU'] ?></p>
                          </div>
                      </div>
                      </div>
                <?php endforeach; ?>
